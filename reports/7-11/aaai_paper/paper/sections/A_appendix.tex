...
Table~\ref{tab:injection} is the numeric form of Figure~\ref{fig:scan}, with the seed annotations spelled out.
...
Our anatomy repeatedly reached conclusions opposite to those suggested by common metrics; the decision rules of \S\ref{sec:setup} distill the following five failure modes, each of which reversed at least one finding.
